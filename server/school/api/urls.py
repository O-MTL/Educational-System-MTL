...
from school.api.alumnos.views import AlumnoViewSet
from . import views
...
router.register(r'estudiantes', AlumnoViewSet, basename='estudiante')  # Alias para compatibilidad con Angular
